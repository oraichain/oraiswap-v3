...
//     pub fn key(&self) -> Addr {
//         Addr::create_program_address(&self.seeds(), &crate::id()).unwrap()
//     }
...
//         new_pool.token_mint_0 = Addr::new_unique();
//         new_pool.token_mint_1 = Addr::new_unique();
//         new_pool.amm_config = Addr::new_unique();
...
//         new_pool.bump = [Addr::find_program_address(
//             &[
//                 &POOL_SEED.as_bytes(),
