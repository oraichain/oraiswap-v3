...
pub struct PoolState {
    ...
    pub token_mint_0: Addr,
    pub token_mint_1: Addr,

    /// Token pair vault
    pub token_vault_0: Addr,
    pub token_vault_1: Addr,

    /// observation account key
    pub observation_key: Addr,
...
impl Default for PoolState {
    fn default() -> Self {
        Self {
            ...
            amm_config: Addr::unchecked(""),
            owner: Addr::unchecked(""),
            token_mint_0: Addr::unchecked(""),
            token_mint_1: Addr::unchecked(""),
            token_vault_0: Addr::unchecked(""),
            token_vault_1: Addr::unchecked(""),
            observation_key: Addr::unchecked(""),
            mint_decimals_0: Default::default(),
            mint_decimals_1: Default::default(),
            tick_spacing: Default::default(),
            liquidity: Default::default(),
            sqrt_price_x64: Default::default(),
            tick_current: Default::default(),
            observation_index: Default::default(),
            observation_update_duration: Default::default(),
            fee_growth_global_0_x64: Default::default(),
            fee_growth_global_1_x64: Default::default(),
            protocol_fees_token_0: Default::default(),
            protocol_fees_token_1: Default::default(),
            swap_in_amount_token_0: Default::default(),
            swap_out_amount_token_1: Default::default(),
            swap_in_amount_token_1: Default::default(),
            swap_out_amount_token_0: Default::default(),
            status: Default::default(),
            padding: Default::default(),
            reward_infos: vec![],
            tick_array_bitmap: Default::default(),
            total_fees_token_0: Default::default(),
            total_fees_claimed_token_0: Default::default(),
            total_fees_token_1: Default::default(),
            total_fees_claimed_token_1: Default::default(),
            fund_fees_token_0: Default::default(),
            fund_fees_token_1: Default::default(),
...
impl PoolState {
    ...
    pub fn seeds(&self) -> [&[u8]; 5] {
        [
            &POOL_SEED.as_bytes(),
            self.amm_config.as_bytes(),
            self.token_mint_0.as_bytes(),
            self.token_mint_1.as_bytes(),
            self.bump.as_ref(),
        ]
    }
    ...
    //         let reward_mints: Vec<Addr> = reward_infos
    //             .into_iter()
    ...
    pub fn get_tick_array_offset(
        &self,
        tick_array_start_index: i32,
    ) -> Result<usize, ContractError> {
        if !TickArrayState::check_is_valid_start_index(tick_array_start_index, self.tick_spacing) {
    ...
    fn flip_tick_array_bit_internal(
        &mut self,
        tick_array_start_index: i32,
    ...
    pub fn flip_tick_array_bit(
        &mut self,
        tickarray_bitmap_extension: Option<Addr>,
        tick_array_start_index: i32,
    ) -> Result<(), ContractError> {
        if self.is_overflow_default_tickarray_bitmap(vec![tick_array_start_index]) {
            if tickarray_bitmap_extension
                .unwrap()
                .as_bytes()
                .ne(&self.key())
            {
                return Err(ContractError::InvalidTickArray);
            }
...
impl Default for RewardInfo {
    fn default() -> Self {
        Self {
            reward_state: Default::default(),
            open_time: Default::default(),
            end_time: Default::default(),
            last_update_time: Default::default(),
            emissions_per_second_x64: Default::default(),
            reward_total_emissioned: Default::default(),
            reward_claimed: Default::default(),
            token_mint: Addr::unchecked(""),
            token_vault: Addr::unchecked(""),
            authority: Addr::unchecked(""),
            reward_growth_global_x64: Default::default(),
        }
    }
}
...
impl RewardInfo {
    ...
    //     pub fn new(authority: Addr) -> Self {
    //         Self {
    //             authority,
    //             ..Default::default()
    //         }
    ...
    //         self.token_mint.ne(&Addr::default())
    //     }
    ...
    //     pub recipient_token_account_0: Addr,

    //     /// The address that receives the collected token_1 protocol fees
    //     pub recipient_token_account_1: Addr,
...
pub mod pool_test {
    ...
    pub fn build_pool(
        ...
        new_pool.token_mint_0 = Addr::unchecked("");
        new_pool.token_mint_1 = Addr::unchecked("");
        new_pool.amm_config = Addr::unchecked("");
    ...
    //                 bump: 0,
    //                 operation_owners: [Addr::default(); OPERATION_SIZE_USIZE],
    //                 whitelist_mints: [Addr::default(); WHITE_MINT_SIZE_USIZE],
    //             };
    //             pool_state
    //                 .initialize_reward(
    //                     1665982800,
    //                     1666069200,
    //                     10,
    //                     &Addr::from_str("So11111111111111111111111111111111111111112").unwrap(),
    //                     &Addr::default(),
    //                     &Addr::default(),
    //                     &operation_state,
    //                 )
